...
import { Property, PropertyType, ListingStatus } from '../properties/entities/property.entity';
...
describe('FavoritesService', () => {
    ...
    describe('getFavoriteStatus', () => {
        it('should return favorited status and count', async () => {
            ...
            const result = await service.getFavoriteStatus(mockUserId, mockPropertyId);
