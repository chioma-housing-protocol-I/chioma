...
describe('ClientErrorBoundary – error classification logic', () => {
    ...
    it('classifies a generic Error as system error', () => {
        ...
        const appError = classifyUnknownError(error, { source: 'ClientErrorBoundary' });
    ...
    it('passes through an existing AppError unchanged', () => {
        ...
        const result = classifyUnknownError(original, { source: 'ClientErrorBoundary' });

        expect(result).toBe(original);
    });

    it('classifies unknown non-Error values', () => {
        const appError = classifyUnknownError('some string error', { source: 'ClientErrorBoundary' });
    ...
    it('classifies null as unknown error', () => {
        const appError = classifyUnknownError(null, { source: 'ClientErrorBoundary' });
