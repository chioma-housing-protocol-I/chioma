  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-6 border border-white/10 space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <span
          className={`px-3 py-1 rounded-lg text-xs font-semibold border ${statusColor} capitalize`}
        >
          {apiKey.status}
        </span>
      </div>
      ...
      <div className="bg-white/5 border border-white/10 rounded-xl p-4">
        <p className="text-xs text-blue-200/60 uppercase tracking-wide mb-2">
          API Key
        </p>
